...
import { BookCopyIcon, LayoutDashboard } from "lucide-react";
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: <BookCopyIcon className="w-5" />,
        label: "Classes",
        route: "/classes",
      },
      {
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Logo>
            <svg
              ...
              className="lucide lucide-book-open-text h-8 w-8 text-greenColor group-hover:text-greenColor/90"
            >
              <path d="M12 7v14" />
              <path d="M16 12h2" />
              <path d="M16 8h2" />
